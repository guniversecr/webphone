        ...
        config : {
                ...
                media: { 
                    ...
                    { 
                        ...
                        render: { remote: document.getElementById("voice") } 
                    },
...
//////////////////////////////////////////////////////////////////////////////////////
            ...
            if (callActive) {
                i += '<div class="btn-group btn-group-lg pull-right">';
                if (item.status === 'ringing' && item.flow === 'incoming') {
                    i += '<button class="btn btn-lg btn-success btnCall" title="Call"><i class="fa fa-phone"></i></button>';
                } else {
                    i += '<button class="btn btn-lg btn-primary btnHoldResume" title="Hold"><i class="fa fa-pause"></i></button>';
                    i += '<button class="btn btn-lg btn-info btnTransfer" title="Transfer"><i class="fa fa-random"></i></button>';
                    i += '<button class="btn btn-lg btn-warning btnMute" title="Mute"><i class="fa fa-fw fa-microphone"></i></button>';
                }
